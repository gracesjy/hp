...
함께 했었다.  <br>
PL/SQL, Function, Pro*C 등을 해 보았지만 이것 말고도 Oracle Database 는 마지막 퍼즐을 제공한다. 이것을 아는 이는 한국에는 거의 없으며
이 기반으로 개발을 하는 것은 전 세계적으로도 손으로 꼽을 정도로 적다. <br>
...
그래서 DBA 도, SQL 잘 만드는 엔지니어들도 전혀 도움이 되지 않고 무엇보다 이런 것들을 전혀 모른다는 것이다. <br>
