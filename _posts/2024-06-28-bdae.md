...
2. Unlike BigQuery on GCP, you can create models and perform inferences by tuning data and deciding on algorithms yourself.
...
5. Python and R codes exist in the DB and can be applied immediately without code modification.
