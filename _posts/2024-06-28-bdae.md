...
***It*** is built on Oracle In-Database technology and has platform features that enable ***Oracle Database&trade***
...
## <span style="color:blue">How To run (3 Steps to Run !)</span>
...
[Big Data Analysis Enabler Manual(English)](https://github.com/gracesjy/hp/blob/master/assets/BDAE_Manual.pdf)
