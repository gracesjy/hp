...
### ✅ Design Schema
Schemas for unstructured tables are very difficult to create with a single query. Therefore, it is effective to use Dynamic SQL or Python.<br>
To create a table using Spire-Doc in Python, you need to be familiar with the table API, and accordingly, you need to understand the composition of the Vertical and Horizontal Merge APIs and prepare a schema that matches them.<br>
